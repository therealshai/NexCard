          ...
          <div className="container mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-foreground">
                Meet <span className="text-primary">CardCraft</span>
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
                ...
                <ul className="space-y-4">
                  {benefits.map((benefit, index) => (
                    <li key={index} className="flex items-start">
                      <Check className="mt-1 mr-3 w-5 h-5 text-primary" />
                      <span>{benefit}</span>
                    </li>
                  ))}
                </ul>
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-primary/30 to-primary/10 rounded-lg flex items-center justify-center p-4">
                  <div className="w-full max-w-sm border border-border/50 rounded-lg shadow-lg bg-card">
                    <div className="p-6 text-center">
                      <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary/80 to-primary/40 mx-auto mb-4"></div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-4">
                        <div className="p-2 bg-primary/10 rounded text-foreground text-sm">jane@example.com</div>
                        <div className="p-2 bg-primary/10 rounded text-foreground text-sm">+1 555-123-4567</div>
                      </div>
                ...
                <div className="mt-6 text-center">
                  <p className="font-medium text-foreground">Preview of a CardCraft social card</p>
            ...
            >
              <h2 className="text-3xl font-bold mb-6 text-foreground">Ready to Create Your First Card?</h2>
